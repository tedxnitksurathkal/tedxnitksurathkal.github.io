(function ($) {
  ...
  /**
   * Function to  save the user score and  data in the MongoDB.
   */

  function dbSaver() {
    const Name = "<some name here>";
    const Roll_No = "<some roll here>";
    const API_URL = "127.0.0.1:3001/update";

    fetch(API_URL, {
      headers: { "Content-Type": "application/json" },
      method: "POST",
      body: JSON.stringify({ Name, Roll_No, Score: score }),
    })
      .then((res) => {
        res.json();
      })

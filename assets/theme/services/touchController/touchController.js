...
export class TouchController {
    ...
    touchstart(e) {
        ...
        for (let i = e.changedTouches.length - 1; i >= 0; i--) {
            ...
            this.pointers.set((touch === null || touch === void 0 ? void 0 : touch.identifier) || 0, touch);
        }
    ...
    mousemove(e) {
        ...
        if (this.currentEvent === GESTURE.SCALE) {
            ...
            data.drag = {
                x: e.pageX - ((data === null || data === void 0 ? void 0 : data.origin.x) || 0),
                y: e.pageY - ((data === null || data === void 0 ? void 0 : data.origin.y) || 0)
            };
    ...
    wheel(e) {
        ...
        const { lastData } = this;
        if (!(lastData === null || lastData === void 0 ? void 0 : lastData.drag)) {
            return;
        }
